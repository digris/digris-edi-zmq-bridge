#!/usr/bin/env python3
#
# A munin plugin for ODR-EDI2EDI
#
...
#
# Copy this to /etc/munin/plugins/stats_edi2edi_munin
# and make it executable (chmod +x)
#
# Then make sure that edi2edi log output gets written to LOGFILE below,
...
NUM_LINES = int(300 / 6)
LOGFILE = "/var/log/supervisor/edi2edi.log"
...
multigraph late_packets_edi2edi
